...
class SubscriptionCalendarWidget extends StatelessWidget {
  const SubscriptionCalendarWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<SubscriptionRegistrationDateViewModel>(
